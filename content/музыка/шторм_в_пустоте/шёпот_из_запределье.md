...
<body>
  ...
  <div class="content">
    <h1>шёпот_из_запределье</h1>
    <p><strong>Author:</strong> zqwy</p>
    <img class="cover" src="https://i.pinimg.com/474x/5d/a6/a4/5da6a46cf3001323588b55d097de56ea.jpg" alt="zqwy_шёпот_из_запределье" />
    <section>
      <h2>Описание</h2>
      <p></p>
    </section>
    ...
    <section>
      <h2>Инструменты</h2>
      <p>synth, rhodes, flute</p>
    </section>

    <iframe name="player" class="player" src="" scrolling="no" title="zqwy_шёпот_из_запределье"></iframe>
  </div>
</body>

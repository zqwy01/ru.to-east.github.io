...
<body>
  ...
  <div class="content">
    ...
    <img class="cover" src="" alt="zqwy_сон" />
    <section>
      <h2>Описание</h2>
      <p></p>
    </section>
    <section>
      <h2>Инструменты</h2>
      <p>Синтезатор, фортепиано, флейта, драм-машина tr-808 </p>
    </section>
    <iframe name="player" class="player" src="" scrolling="no" title="zqwy_сон"></iframe>

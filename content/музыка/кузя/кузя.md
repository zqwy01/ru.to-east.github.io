...
<body>
  ...
  <div class="content">
    ...
    <img class="cover" src="https://ia600604.us.archive.org/4/items/zqwy_kuzya/zqwy_kuzya_cover_site.webp" alt="zqwy_кузя" />
    <section>
      <h2>Описание</h2>
    ...
    <section>
      <h2>Инструменты</h2>
      <p>- Piano   - Synthesizer   - Guitar   - Harpa   - Flute   - Violin   - Acoustic Guitar </p>
    </section>
    <iframe name="player" class="player" src="https://archive.org/details/zqwy_kuzya" scrolling="no" title="zqwy_кузя"></iframe>

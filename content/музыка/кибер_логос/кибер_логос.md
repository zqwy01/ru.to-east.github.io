...
<body>
  ...
  <div class="content">
    ...
    <img class="cover" src="https://ia902908.us.archive.org/2/items/cyber_logos/zqwy_cyber_logos_cover_site.webp" alt="zqwy_кибер_логос" />
    <section>
      <h2>Описание</h2>
    ...
    <section>
      <h2>Инструменты</h2>
      <p>Synthesizer, sampler </p>
    </section>

    <iframe name="player" class="player" src="https://archive.org/details/cyber_logos" scrolling="no" title="zqwy_кибер_логос"></iframe>
  </div>
</body>

...
<body>
  ...
  <div class="content">
    ...
    <h1>конец_духовности</h1>
    <p><strong>Author:</strong> zqwy</p>
    <img class="cover" src="" alt="zqwy_конец_духовности" />
    <section>
      <h2>Описание</h2>
    ...
    <iframe name="player" class="player" src="" scrolling="no" title="zqwy_конец_духовности"></iframe>

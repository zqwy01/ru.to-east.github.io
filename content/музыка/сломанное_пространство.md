...
<body>
  ...
  <div class="content">
    <h1>сломанное_пространство</h1>
    <p><strong>Author:</strong> zqwy</p>
    <img class="cover" src="https://ia601802.us.archive.org/8/items/zqwy_broken_space/zqwy_broken_space_cover_site.webp" alt="zqwy_сломанное_пространство" />
    <section>
      <h2>Описание</h2>
    ...
    <iframe name="player" class="player" src="https://archive.org/details/zqwy_broken_space" scrolling="no" title="zqwy_сломанное_пространство"></iframe>
  </div>
</body>
